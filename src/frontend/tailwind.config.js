  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Axiom AI brand tokens
        emerald: "oklch(var(--emerald))",
        obsidian: "oklch(var(--obsidian))",
      ...
      boxShadow: {
        ...
        "emerald-sm": "0 0 16px rgba(0,200,150,0.25)",
        "emerald-md": "0 0 30px rgba(0,200,150,0.35)",
        "emerald-lg": "0 0 60px rgba(0,200,150,0.2)",
        "gold-sm": "0 0 16px rgba(212,175,55,0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
